  ...
  angular.module('mtgx.controllers').controller('OverviewController',
  ['$scope', '$ionicModal', '$ionicPlatform', 'BirthdayService', OverviewController]);
  ...
  function OverviewController($scope, $ionicModal, $ionicPlatform, birthdayService) {
    ...
    $ionicModal.fromTemplateUrl('templates/birthdaymodal.html', {
      scope: $scope,
